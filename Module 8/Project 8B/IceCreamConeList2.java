...
/////////////////////////////////////////////////////////////////////////////
   ...
   /**
    * Returns Ice Cream Cone with shortest radius.
    * @return icc, null  
    */
   public IceCreamCone findIceCreamConeWithShortestRadius()
   {
      // Variables
      IceCreamCone shortestRadius = new IceCreamCone("", 999999, 999999);
      
      // Retrieving Shortest and Exception Handling
      if (listLength == 0)
      {
         return null;
      }
      ...
      {
         for (IceCreamCone icc : list)
         {
            if (icc.getRadius() < shortestRadius.getRadius())
            {
               shortestRadius = icc;
            }
         }
   ...
   /**
    * Returns Ice Cream Cone with longest radius.
    * @return icc, null  
    */
   public IceCreamCone findIceCreamConeWithLongestRadius()
   {
      // Variables
      IceCreamCone longestRadius = new IceCreamCone("", 0, 0);
   ...
   /**
    * Returns Ice Cream Cone with smallest volume.
    * @return icc, null  
    */
   public IceCreamCone findIceCreamConeWithSmallestVolume()
   {
      // Variables
      IceCreamCone smallestVolume = new IceCreamCone("", 99999, 999999);
      ...
      else
      {
         for (IceCreamCone icc : list)
         {
            if (icc.volume() < smallestVolume.volume())
            {
               smallestVolume = icc;
            }
         }
   ...
   /**
    * Returns Ice Cream Cone with largest volume.
    * @return icc, null  
    */
   public IceCreamCone findIceCreamConeWithLargestVolume()
   {
      // Variables
      IceCreamCone largestVolume = new IceCreamCone("", 0, 0);
